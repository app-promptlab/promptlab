      ...
      {config?.show_header && (
        <div className="relative w-full h-[40vh] min-h-[350px] overflow-hidden flex items-center justify-center text-center px-6">
            ...
            <div className="relative z-10 max-w-4xl">
                <h1 className="text-4xl md:text-6xl font-black text-white mb-4 tracking-tighter drop-shadow-lg uppercase">{replaceVariables(config.title || pageId)}</h1>
                <p className="text-gray-200 text-lg md:text-xl drop-shadow-md font-medium">{replaceVariables(config.subtitle)}</p>
            </div>
        </div>
      )}
